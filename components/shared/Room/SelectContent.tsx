  ...
  return (
    <>
      <div className="flex my-10 gap-5 items-center">
        <span className="bg-primary w-5 h-5 flex justify-center items-center rounded-2xl p-3 text-white">
          1
        </span>
      ...
      <div className="bg-surface-dark flex flex-col items-center justify-center  h-full p-5 w-max-3xl rounded-lg">
